...
class BoardPanel extends JPanel {
	...
	// d�clarations des couleurs utilis�es pour les tuiles
	final static Color COLOURCELL = Color.ORANGE;
	final static Color COLOURGRID = Color.BLACK;
	final static Color COLOURRIGHT = Color.GREEN;
	final static Color COLOURORWRONG = Color.RED;
	
	// par d�faut le personnage apparait au coordonn�es x0 y0
	...
	//�l�ments relatifs � la fenetre
	private JFrame frame; 
	private int frameWidth;
	private Cursor cursor;

	//valeurs des bordures la bordure y est fixe mais la bordure x s'adapte � la taille de la fenetre
	private int BORDERX = 0;
	private final static int BORDERY = 0;
	
	//�l�ment relatifs � la carte de fond
	...
	/**
	 * Contructeur, il sp�cifie un �couteur de base et de mouvement pour les interactions de la souris sur le BoardPanel
	 */
	 ...
	 * 
	 * @param g Graphics �l�ment graphique du plateau
	 */
	...
	/**
	 * Classe MouseListener qui �coute toutes les interactions faite par la souris sur le BoardPanel (d�placement clique ect..)
	 * 
	 * @author benoit
	 *
	 */
